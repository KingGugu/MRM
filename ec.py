...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='./protein-data/ec', type=str, metavar='N', help='data root directory')
    ...
    parser.add_argument("--model_name", default='CSConv-ec', type=str)
