...
def parse_args():
    ...
    parser.add_argument('--data-dir', default='./protein-data/func', type=str, metavar='N', help='data root directory')
    ...
    parser.add_argument("--model_name", default='CSConv-func', type=str)
    ...
    parser.add_argument('--alpha1_start', default=6, type=int, help='initial value of α1')
    ...
    parser.add_argument('--alpha2_end', default=6, type=int, help='final value of α2')
...
if __name__ == '__main__':
    ...
    for epoch in range(args.num_epochs):
        ...
        with open(args.log_file, 'a') as f:
            f.write(f'Epoch: {epoch + 1:03d}, Validation: {valid_acc:.4f}, Test: {test_acc:.4f} \n')
    ...
    print(
        f'\nBest Epoch: {best_epoch + 1:03d}, Validation: {best_valid_acc:.4f}, Test: {best_acc:.4f} \n')
    print(
        f'Best Performance:, Test: {best_test_acc:.4f} \n')
    with open(args.log_file, 'a') as f:
        f.write(f'\nBest Epoch: {best_epoch + 1:03d}, Validation: {best_valid_acc:.4f}, Test: {best_acc:.4f} \n')
        f.write(f'Best Performance: Test: {best_test_acc:.4f} \n')
